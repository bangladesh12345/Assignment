...
public class Assi {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        File file1 = new File("Files//input.txt");
        ...
        File file2 = new File("Files//input.txt");
        ...
        File file3 = new File("Files//input.txt");
        ...
        File file4 = new File("Files//input.txt");
        ...
        File file5 = new File("Files//input.txt");
